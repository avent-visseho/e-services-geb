...
import IdentifiantCard from "../../components/wizard/IdentifiantCard.vue"
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Enrégistrement d'une nouvelle demande</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div id="progrss-wizard" class="twitter-bs-wizard">
                            <ul class="twitter-bs-wizard-nav nav nav-pills nav-justified">
                                <li class="nav-item">
                                    <a href="#progress-listDoc-details" class="nav-link" data-toggle="tab">
                                        <div class="step-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="listDoc Details">
                            ...
                            <div class="tab-content twitter-bs-wizard-tab-content">
                                <div class="tab-pane" id="progress-listDoc-details">
                                    <div class="text-center mb-4">
                                        <h5>List document</h5>
                                        <p class="card-title-desc">Fill all information below</p>
                                    </div>
                                    <form>
                                        un tableau à mettre en place pour les types de document
                                    </form>
                                    <ul class="pager wizard twitter-bs-wizard-pager-link">
                                        <li class="next"><a href="javascript: void(0);" class="btn btn-success">Suivant
                                ...
                                <div class="tab-pane" id="progress-seller-details">
                                    <div class="text-center mb-4">
                                        <h5>Formulaire</h5>
                                        <p class="card-title-desc">Formulaire</p>
                                    </div>
                                    <form>
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control"
                                                        id="progresspill-email-input" placeholder="Enter your Email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="tab-pane" id="progress-company-document">
                                    <div>
                                        <div class="text-center mb-4">
                                            ...
                                            <p class="card-title-desc">Choisir pièces à fournir</p>
                                        </div>
                                        <form>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Type de pièces</label>
                                                        <select class="form-select">
                                                            <option>Type de pièces</option>
                                                            <option>passport</option>
                                                            <option>Carte National d'Identité</option>
                                                            <option>Récipissé Ravip</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="progresspill-vatno-input" class="form-label">Numéro de la pièce</label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="progresspill-cstno-input" class="form-label">Fichier</label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="progresspill-servicetax-input"
                                                            class="form-label">Informations additionnelles</label>
                                                        <input type="text" class="form-control"
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="javascript: void(0);"
                                                    class="btn btn-success"><i class="bx bx-chevron-left me-1"></i>
                                                    Precédent</a>
                                            </li>
                                ...
                                <div class="tab-pane" id="progress-bank-detail">
                                    <div>
                                        <div class="text-center mb-4">
                                            <h5>Récap des information fournies</h5>
                                            <p class="card-title-desc">Veuillez vérifier les information</p>
                                        </div>
                                        <form>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="progresspill-card-verification-input"
                                                            class="form-label">Card Verification
                                                            Number</label>
                                                        <input type="text" class="form-control"
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            ...
                                            <li class="float-end"><a href="javascript: void(0);" class="btn btn-success"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button type="button" class="btn btn-success w-md" data-bs-dismiss="modal">Save
                        changes</button>
                </div>
            </div>
        </div>
